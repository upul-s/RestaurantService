...
public class RestaurantService {
	...
	public Restaurant createRestaurant(String name, String city, String addressLine1, String addressLine2,
									   String zipCode, String country, Status status) {
		Restaurant restaurant = restaurantRepository
				.save(Restaurant
						.create(name, city, addressLine1, addressLine2, zipCode, country, status));
